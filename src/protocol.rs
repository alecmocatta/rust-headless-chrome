...
// 15f524c8f5ce5b317ddcdf5e6f875d6eb8bdac88
pub mod cdp {
	pub mod types {
	...
	pub mod Profiler {
		use super::{types::*, Debugger, Runtime};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
		#[serde(rename_all = "camelCase")]
	...
	pub mod Accessibility {
		use super::{types::*, Page, Runtime, DOM};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
	...
	pub mod Audits {
		use super::{types::*, Network, Page, Runtime, DOM};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
	...
	pub mod BackgroundService {
		use super::{types::*, Network, ServiceWorker};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
	...
	pub mod DOMDebugger {
		use super::{types::*, Debugger, Runtime, DOM};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
	...
	pub mod DOMSnapshot {
		use super::{types::*, DOMDebugger, Page, CSS, DOM};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
	...
	pub mod Log {
		use super::{types::*, Network, Runtime};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
	...
	pub mod Network {
		use super::{types::*, Debugger, Emulation, Network, Page, Runtime, Security, IO};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
	...
	pub mod Page {
		use super::{types::*, Debugger, Emulation, Network, Runtime, DOM, IO};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
	...
	pub mod PerformanceTimeline {
		use super::{types::*, Network, Page, DOM};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
		#[serde(rename_all = "camelCase")]
	...
	pub mod Storage {
		use super::{types::*, Browser, Network};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
	...
	pub mod Fetch {
		use super::{types::*, Network, Page, IO};
		use serde::{Deserialize, Serialize};
		use serde_json::Value as Json;
		pub type RequestId = String;
		#[derive(Deserialize, Serialize, Debug, Clone, PartialEq)]
